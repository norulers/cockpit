...
export const getCockpitActions = (): { [key in CockpitActionsFunction]: CockpitAction } => ({
  [CockpitActionsFunction.go_to_next_view]: new CockpitAction(CockpitActionsFunction.go_to_next_view, i18n.global.t('Go to next view')),
  [CockpitActionsFunction.go_to_previous_view]: new CockpitAction(CockpitActionsFunction.go_to_previous_view, i18n.global.t('Go to previous view')),
  [CockpitActionsFunction.toggle_full_screen]: new CockpitAction(CockpitActionsFunction.toggle_full_screen, i18n.global.t('Toggle full screen')),
  [CockpitActionsFunction.mavlink_arm]: new CockpitAction(CockpitActionsFunction.mavlink_arm, i18n.global.t('Mavlink arm')),
  [CockpitActionsFunction.mavlink_disarm]: new CockpitAction(CockpitActionsFunction.mavlink_disarm, i18n.global.t('Mavlink disarm')),
  [CockpitActionsFunction.toggle_bottom_bar]: new CockpitAction(CockpitActionsFunction.toggle_bottom_bar, i18n.global.t('Toggle bottom bar')),
  [CockpitActionsFunction.toggle_top_bar]: new CockpitAction(CockpitActionsFunction.toggle_top_bar, i18n.global.t('Toggle top bar')),
  [CockpitActionsFunction.start_recording_all_streams]: new CockpitAction(CockpitActionsFunction.start_recording_all_streams, i18n.global.t('Start recording all streams')),
  [CockpitActionsFunction.stop_recording_all_streams]: new CockpitAction(CockpitActionsFunction.stop_recording_all_streams, i18n.global.t('Stop recording all streams')),
  [CockpitActionsFunction.toggle_recording_all_streams]: new CockpitAction(CockpitActionsFunction.toggle_recording_all_streams, i18n.global.t('Toggle recording all streams')),
  [CockpitActionsFunction.take_snapshot]: new CockpitAction(CockpitActionsFunction.take_snapshot, i18n.global.t('Take snapshot')),
  [CockpitActionsFunction.hold_to_confirm]: new CockpitAction(CockpitActionsFunction.hold_to_confirm, i18n.global.t('Hold to confirm')),
})
...
export class CockpitActionsManager {
  ...
  registerNewAction = (_action: CockpitAction): void => {
    console.warn('registerNewAction is not supported with dynamic translations')
  }

  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  unregisterAction = (_id: CockpitActionsFunction): void => {
...
/**
 * Get all available cockpit actions with current translations
 * @returns {{ [key in CockpitActionsFunction]: CockpitAction }} Record of all available cockpit actions
 */
